...
class Home extends React.Component<IProps, IState>{
  ...
  getTechnologyShare() {
    const that = this;
    fetch('https://www.azjfeng.com/common/getTechnologyShare', {
      method: "post",
